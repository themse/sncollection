...
export const Welcome = () => {
	return (
		<div className="flex h-full flex-col items-center justify-start gap-x-4 gap-y-10 py-4 md:h-screen md:flex-row md:justify-between">
			<div className="w-11/12 sm:w-8/12 md:w-5/12 lg:w-6/12 xl:w-7/12">
			...
			<div className="flex w-full flex-col gap-y-14 md:w-7/12 lg:w-6/12 xl:w-4/12">
				<div className="space-y-6 text-center md:text-left">
					<Heading
						as="h1"
						className="sm:leading-12 text-4xl leading-10 sm:text-5xl xl:text-6xl xl:leading-16"
					>
